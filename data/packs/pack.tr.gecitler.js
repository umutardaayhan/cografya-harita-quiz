...
GeoPacks.register("tr.gecitler", {
  ...
  categories: ["gecitler"],
  items: [
    {"id":"gecit_gulek","cat":"gecitler","tier":1,"geom":{"t":"point","lat":37.25,"lng":34.79},"sub":["akdeniz"],"groupId":"grp_gulek_bogazi","i18n":{"tr":{"name":"Gülek Boğazı / Geçidi","type":"Dağ Geçidi","region":"Akdeniz / Orta Toroslar","city":"Adana - Mersin (Pozantı)","note":"Çukurova'yı (Adana/Mersin) İç Anadolu'ya (Niğde/Pozantı) bağlayan, tarihten bu yana en işlek Toros geçididir."}}},
    ...
    {"id":"gecit_zigana","cat":"gecitler","tier":1,"geom":{"t":"point","lat":40.64,"lng":39.43},"sub":["karadeniz"],"groupId":"grp_trabzon_zigana_koridoru","i18n":{"tr":{"name":"Zigana (Kalkanlı) Geçidi","type":"Dağ Geçidi","region":"Karadeniz","city":"Trabzon - Gümüşhane","note":"Tarihi İpek Yolu güzergahında Trabzon Limanı'nı Gümüşhane ve Doğu Anadolu'ya bağlar. Yeni Zigana Tüneli Avrupa'nın en uzun tünellerindendir."}}},
    ...
    {"id":"gecit_ovit","cat":"gecitler","tier":2,"geom":{"t":"point","lat":40.62,"lng":40.79},"sub":["karadeniz"],"groupId":"grp_ovit_koridoru","i18n":{"tr":{"name":"Ovit Geçidi","type":"Dağ Geçidi","region":"Karadeniz / Doğu Anadolu","city":"Rize - Erzurum (İkizdere)","note":"Rize (İkizdere) ile Erzurum (İspir) arasındadır. Ovit Tüneli ile kışın kapanan yol yıl boyu açık hale getirilmiştir."}}},
    {"id":"gecit_ilgaz","cat":"gecitler","tier":2,"geom":{"t":"point","lat":41.07,"lng":33.74},"sub":["karadeniz"],"groupId":"grp_ilgaz_koridoru","i18n":{"tr":{"name":"Ilgaz Geçidi","type":"Dağ Geçidi","region":"Karadeniz / İç Anadolu","city":"Kastamonu - Çankırı","note":"Kastamonu ile Çankırı/Ankara arasındaki Ilgaz Dağları'nı aşan geçittir."}}},
