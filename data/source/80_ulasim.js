...
Object.assign(COGRAFYA_DATA_EXT, {
  ulasim: [
    ...
    },
    {
      ...
      lat: 38.05, lng: 27.35,
      shapeType: "polyline",
      coordinates: [[38.44, 27.15], [38.36, 27.19], [38.15, 27.36], [37.95, 27.37], [37.87, 27.60], [37.85, 27.84]],
      region: "Ege",
    ...
    },
    {
      ...
      lat: 40.75, lng: 29.90,
      shapeType: "polyline",
      coordinates: [[40.99, 29.04], [40.88, 29.25], [40.80, 29.43], [40.76, 29.92], [40.72, 30.37], [40.51, 30.17], [40.36, 30.02], [40.14, 29.98], [39.91, 30.04], [39.78, 30.51]],
      region: "Marmara",
    ...
    },
    {
      ...
      lat: 37.50, lng: 32.80,
      shapeType: "polyline",
      coordinates: [[39.93, 32.86], [39.58, 32.15], [39.00, 32.38], [38.40, 32.50], [37.87, 32.49], [37.50, 32.85], [37.18, 33.22]],
      region: "İç Anadolu",
      city: "Konya - Karaman",
    ...
    },
    {
      ...
      lat: 39.75, lng: 37.01,
      shapeType: "polyline",
      coordinates: [[39.93, 32.86], [39.92, 33.23], [39.85, 33.51], [39.64, 34.47], [39.80, 35.19], [39.72, 35.85], [39.87, 36.60], [39.75, 37.02]],
      region: "İç Anadolu",
    ...
    // C. TURİSTİK DOĞU EKSPRESİ (Ankara - Kars)
    {
      ...
      lat: 39.20, lng: 34.20,
      shapeType: "polyline",
      coordinates: [[39.93, 32.86], [39.92, 33.23], [39.85, 33.51], [39.64, 34.47], [39.50, 34.76], [39.05, 35.25], [38.72, 35.49]],
      region: "İç Anadolu",
    ...
    },
    {
      ...
      lat: 39.60, lng: 38.80,
      shapeType: "polyline",
      coordinates: [[38.72, 35.49], [39.35, 36.41], [39.75, 37.02], [39.25, 37.62], [39.37, 38.11], [39.45, 38.56], [39.60, 39.03], [39.74, 39.49]],
      region: "Doğu Anadolu",
    ...
    },
    {
      ...
      lat: 40.30, lng: 42.20,
      shapeType: "polyline",
      coordinates: [[39.74, 39.49], [39.78, 40.39], [39.92, 40.69], [39.90, 41.27], [40.04, 42.17], [40.33, 42.59], [40.61, 43.10]],
      region: "Doğu Anadolu",
    ...
    // D. MEZOPOTAMYA EKSPRESİ (Ankara - Diyarbakır)
    {
      ...
      lat: 38.50, lng: 38.80,
      shapeType: "polyline",
      coordinates: [[38.35, 38.31], [38.42, 38.70], [38.57, 39.10], [38.67, 39.22], [38.39, 39.67], [38.27, 39.76], [37.91, 40.22]],
      region: "Doğu Anadolu",
      city: "Malatya - Elazığ",
    ...
    // A. BATI OTOYOL AKSI (Edirne'den Denizli'ye)
    {
      ...
      lat: 41.35, lng: 27.50,
      shapeType: "polyline",
      coordinates: [[41.68, 26.56], [41.55, 26.82], [41.43, 27.09], [41.40, 27.35], [41.16, 27.80], [41.08, 28.15], [41.03, 28.55], [41.05, 28.83]],
      region: "Marmara",
    ...
    },
    {
      ...
      lat: 39.50, lng: 28.00,
      shapeType: "polyline",
      coordinates: [[40.80, 29.43], [40.75, 29.52], [40.49, 29.31], [40.22, 28.98], [39.91, 28.16], [39.65, 27.89], [39.38, 27.66], [39.19, 27.61], [38.92, 27.84], [38.73, 27.57], [38.61, 27.43], [38.47, 27.22]],
      region: "Marmara",
    ...
    },
    {
      ...
      lat: 37.80, lng: 28.50,
      shapeType: "polyline",
      coordinates: [[38.40, 27.17], [38.15, 27.36], [37.87, 27.60], [37.85, 27.84], [37.91, 28.32], [37.92, 28.92], [37.78, 29.09]],
      region: "Ege",
    ...
    // B. ANADOLU OTOYOLU / TEM (İstanbul - Ankara)
    {
      ...
      lat: 40.75, lng: 29.90,
      shapeType: "polyline",
      coordinates: [[41.09, 29.09], [41.02, 29.12], [40.98, 29.23], [40.92, 29.30], [40.83, 29.43], [40.78, 29.53], [40.78, 29.95], [40.70, 30.27], [40.73, 30.40], [40.69, 30.62]],
      region: "Marmara",
    ...
    },
    {
      ...
      lat: 40.50, lng: 31.80,
      shapeType: "polyline",
      coordinates: [[40.69, 30.62], [40.84, 31.16], [40.78, 31.43], [40.73, 31.61], [40.80, 32.20], [40.47, 32.65], [40.20, 32.68], [39.97, 32.75]],
      region: "Karadeniz",
    ...
    // C. GÜNEYDOĞU OTOYOL AKSI (Ankara - Şanlıurfa)
    {
      ...
      lat: 38.70, lng: 34.00,
      shapeType: "polyline",
      coordinates: [[39.79, 32.81], [39.45, 33.20], [39.05, 33.55], [38.40, 34.00], [38.05, 34.40], [37.93, 34.67]],
      region: "İç Anadolu",
    ...
    },
    {
      ...
      lat: 37.10, lng: 37.00,
      shapeType: "polyline",
      coordinates: [[37.43, 34.87], [36.95, 34.90], [37.02, 35.32], [37.03, 35.82], [37.07, 36.25], [37.20, 36.58], [37.07, 37.38], [37.03, 37.98], [37.16, 38.79]],
      region: "Güneydoğu Anadolu",
    ...
    // D. ADANA - İSKENDERUN OTOYOL KOLU
    {
      ...
      lat: 36.80, lng: 36.00,
      shapeType: "polyline",
      coordinates: [[37.03, 35.82], [37.06, 36.14], [36.95, 36.20], [36.85, 36.22], [36.76, 36.21], [36.58, 36.17]],
      region: "Akdeniz",
